/****************************
 * @file      elgamal.hpp
 * @brief     ElGamal Public Key Encryption (Standard and Exponential).
 * @details   Implementation of ECC-based ElGamal PKE. 
 * - Standard ElGamal: msg_len_bits = 0
 * - Exponential ElGamal: msg_len_bits > 0
 * @author    This file is part of Taihang-Protocols, developed by Yu Chen.
 ****************************/

#ifndef TAIHANG_PROTOCOLS_PKE_ELGAMAL_HPP
#define TAIHANG_PROTOCOLS_PKE_ELGAMAL_HPP
 ...
 * @details Shares the same randomness 'r' (c1) across multiple recipients (c2_vec).
 *          c1 = g^r
 *          c2[i] = pk[i]^r * m
 */
struct MrCiphertext {
    ECPoint c1;
    std::vector<ECPoint> vec_c2;
